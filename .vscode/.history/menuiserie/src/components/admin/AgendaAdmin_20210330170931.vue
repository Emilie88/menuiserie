          ...
          <v-menu bottom>
            ...
            <v-list>
              <v-list-item @click="type = 'day'">
                <v-list-item-title> {{ $t("Common.day") }}</v-list-item-title>
              </v-list-item>
              <v-list-item @click="type = 'week'">
                <v-list-item-title> {{ $t("Common.week") }}</v-list-item-title>
              </v-list-item>
              <v-list-item @click="type = 'month'">
                <v-list-item-title> {{ $t("Common.month") }}</v-list-item-title>
              </v-list-item>
              <v-list-item @click="type = '4day'">
                <v-list-item-title> {{ $t("Common.days") }}</v-list-item-title>
              </v-list-item>
            </v-list>
          </v-menu>
        </v-toolbar>
