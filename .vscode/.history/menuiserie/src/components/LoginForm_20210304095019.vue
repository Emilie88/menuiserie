<template>
  <v-card class="px-4">
    <v-card-text>
      ...
      <div to="/register" color="lime darken-3">
        Vous n'avez pas encore de compte?
        <v-icon large color="lime darken-3">mdi-account-outline</v-icon>
        <router-link to="/register" class="text-decoration-none"> </router-link>
      </div>
    </v-card-text>
  </v-card>
</template>
